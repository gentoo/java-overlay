...
# $Header: /var/cvsroot/gentoo-x86/www-servers/tomcat/tomcat-5.0.28.ebuild,v 1.10 2005/02/14 00:11:02 luckyduck Exp $
...
src_unpack() {
	...
	cd ${S}
	epatch ${FILESDIR}/${PV}/mainbuild-xml.patch
	epatch ${FILESDIR}/${PV}/tomcatbuild-xml.patch
	epatch ${FILESDIR}/${PV}/catalinabuild-xml.patch
	epatch ${FILESDIR}/${PV}/jasperbuild-xml.patch
