...
SLOT="2.3"
KEYWORDS="-*"
# There's some problems with rhino atm...
#KEYWORDS="~amd64 ~x86"
IUSE="doc jikes"
...
GETJARS_ARG="servletapi-2.3,jdom-1.0_beta9,jaxen-1.1,dom4j-1,saxpath,jython,avalon-logkit-2.0,log4j,rhino-1.6"

src_compile() {
	local antflags="-Dproject.name=${PN} jar -Djavacc.home=/usr/share/javacc/lib"
