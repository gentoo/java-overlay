...
# $Header: /var/cvsroot/gentoo-x86/dev-java/gnu-crypto/gnu-crypto-2.0.1-r2.ebuild,v 1.9 2007/03/11 20:47:03 nichoj Exp $
...
DEPEND=">=virtual/jdk-1.3 source? ( app-arch/zip )"
