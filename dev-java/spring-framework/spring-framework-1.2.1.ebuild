...
CGLIB="cglib-2 cglib-full.jar cglib-nodep-2.1.jar"
COS="cos cos.jar"
DOM4J="dom4j-1"
...
src_unpack() {
	...
	# it doesn't seem to like our cglib...
...
#	java-pkg_jar-from ${CGLIB}
	...
	# ${S}/lib/dom4j only needed for examples
	cd ${S}/lib/dom4j
