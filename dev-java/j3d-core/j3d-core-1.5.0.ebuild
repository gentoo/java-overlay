...
# tar -cjf j3d-core-utils-1.5.0.tar.bz2 j3d-core-utils/
# cvs -d :pserver:alistair64@cvs.dev.java.net:/cvs export -r rel-1_5_0-fcs j3d-core
# tar -cjf j3d-core-1.5.0.tar.bz2 j3d-core
...
SRC_URI="http://dev.gentoo.org/~nichoj/distfiles/${P}.tar.bz2
		http://dev.gentoo.org/~nichoj/distfiles/${PN}-utils-${PV}.tar.bz2"
...
src_install() {
	...
	use doc && java-pkg_dojavadoc "build/${arch}/javadocs"
