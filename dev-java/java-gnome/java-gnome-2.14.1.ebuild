...
DEPEND="!<dev-java/java-gnome-2.8
	>=dev-java/glib-java-0.2.5
	>=dev-java/cairo-java-1.0.4
	>=dev-java/libgtk-java-2.8.5
	>=dev-java/libgnome-java-2.12.3
	>=dev-java/libglade-java-2.12.3
	>=dev-java/libgconf-java-2.12.3
	doc? ( >=virtual/jdk-1.4 )"
