...
SRC_URI="https://github.com/Bukkit/CraftBukkit/tarball/${COMMIT} -> ${P}.tar.gz
	http://repo.bukkit.org/content/repositories/libs-release-local/org/bukkit/minecraft-server/${MC_PV}/minecraft-server-${MC_PV}.jar -> ${MC_JAR}"
LICENSE="GPL-3"
SLOT="0"
KEYWORDS="~amd64 ~x86"
IUSE="ipv6"
...
java_prepare() {
	...
	epatch "${FILESDIR}/fix-world_the_end-migration.patch"
}
