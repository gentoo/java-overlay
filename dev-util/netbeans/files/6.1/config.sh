...
function display_usage() {
	einfo "Gentoo Netbeans 6.1 Configuration Utility"
	einfo
	einfo "Usage ${0} <action>"
	einfo "Actions:"
	einfo "  ant      - Configures Netbeans 6.1 ant classpath. Useful if you want to use ant-1.7 with Netbeans."
	...
	einfo "             have to define/update it manually. It is useful if you are upgrading from 5.5 to 6.1 or"
	einfo "             you use both 5.5 and 6.1 and want to copy the settings from one version to the other."
	einfo "             Netbeans 5.5 and 6.1 are supported."
...
function config_ant() {
	einfo "Gentoo Netbeans 6.1 Configuration Utility - Ant Configuration"
	einfo
...
function config_lm() {
	einfo "Gentoo Netbeans 6.1 Configuration Utility - Library Manager Configuration"
	einfo
...
config_server() {
        einfo "Gentoo Netbeans 6.1 Configuration Utility - ${SERVER_NAME} Configuration"
        einfo
        einfo "Provide path to your Netbeans home dir."
        einfo "Default is [${HOME}/.netbeans/dev]:"
        read USERDIR
